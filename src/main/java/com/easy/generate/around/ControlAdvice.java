package com.easy.generate.around;
...
public class ControlAdvice {
     ...
     * </aop:config>
     */
    @Around("execution(* com.easy.generate.controller..*.*(..))")
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            log.info("调用服务[{}] {}.{}" +
                            ...
                            "\n 出参: {}, " +
                            "\n 花费时长: {}.",
                    traceId, controllerName, methodName, JSONObject.toJSON(args), JSONObject.toJSON(response),costTime);
        } catch (Throwable e) {
            log.error("调用服务[{}]{}.{} , 异常" +
                    "\n 入参: {} " +
                    "\n 出参: {}" +
